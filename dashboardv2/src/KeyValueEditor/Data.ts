...
export enum DataActionType {
	SET_KEY_AT_INDEX = 'SET_KEY_AT_INDEX',
	SET_VAL_AT_INDEX = 'SET_VAL_AT_INDEX',
	REBASE = 'REBASE',
...
export type Reducer = (prevData: Data, action: DataAction) => Data;

export function dataReducer(prevData: Data, action: DataAction): Data {
	switch (action.type) {
